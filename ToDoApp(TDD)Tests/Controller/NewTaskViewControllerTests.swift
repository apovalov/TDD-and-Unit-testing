...
class NewTaskViewControllerTests: XCTestCase {
    ...
    func testSaveUsesGeocoderToConvertCoordinateFromAddress() {
        ...
        sut.dateTextField.text = "01.01.09"
        ...
        let date = df.date(from: "01.01.09")
    ...
    func testGeocoderFetchesCorrectCoordinate() {
        ...
        geocoder.geocodeAddressString(addressString) { (placemarks, error) in
            ...
            XCTAssertEqual(latitude, 40.755931)
            XCTAssertEqual(longitude, -73.984606)
    ...
    func testSaveDismissesNewTaskViewController() {
        ...
        mockNewTaskViewController.dateTextField.text = "01.01.09"
